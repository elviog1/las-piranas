  ...
  return (
    <>
      ...
      <div
        ...
        md:relative md:translate-x-0 dark:bg-slate-950 ${
          ...
          <nav className=" flex flex-col gap-2 p-4">
            ...
            <div className="py-4 my-4 border-t">
              <button
                ...
                className="cursor-pointer flex items-center w-full px-3 py-2 rounded-md text-sm font-medium text-red-600 hover:text-red-400 hover:bg-red-50 dark:hover:bg-slate-800"
              >
                Cerrar sesión
              </button>
            </div>
